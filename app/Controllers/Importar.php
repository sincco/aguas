	...
	public function index() {
		...
		if (!$conn) {
			...
			while ($padron = oci_fetch_assoc($stid)) {
				...
				VALUES ('" . $padron["NIS"] . "','" . $padron["ALTACONTRATO"] . "','" . $padron["PROPIETARIO"] . "','" . $padron["USUARIO"] . "','" . $padron["SUMINISTRO"] . "','" . $padron["NUMTOMAS"] . "','" . $padron["GIRO"] . "','" . $padron["UTILIZACION"] . "','" . $padron["TARIFA"] . "','" . $padron["SERVICIOS"] . "','" . $padron["NIVELTARIFARIO"] . "','" . $padron["ASOCIACION"] . "','" . $padron["CVECATASTRAL"] . "','" . $padron["MUNICIPIO"] . "','" . $padron["COLONIA"] . "','" . $padron["VIA"] . "','" . $padron["CALLE"] . "','" . $padron["NUMOFICIAL"] . "','','','','','" . $padron["INTERIOR_1"] . "','" . $padron["INTERIOR_2"] . "','" . $padron["MARCA_ACT"] . "','" . $padron["NUM_APA"] . "','" . $padron["APARATO"] . "','" . $padron["TIP_MEDICION"] . "','" . $padron["F_INST"] . "','" . $padron["ANOS_DISP_MED"] . "','" . $padron["MAYORES_5_ANOS"] . "','" . $padron["F_RETIRO_DISP_MED"] . "','','','','',0,NULL,'','');";
				echo $query . "<br><br>\n";
			}
